                    ...
                    <div className="py-3 px-1 md:w-[22%] min-h-[80vh] z-10 w-full">
                        <div className="mt-8">
                            <ul className="side-links">
                                <Link href='/assessments' onClick={toggleNav} className={`flex items-center gap-2 px-3 py-3 mb-2 rounded-md ${currentPath === '/assessments' ? 'bg-white text-[#2D68A2] active-link' : 'text-[#181A1B]'} hover:bg-white hover:text-[#2D68A2]`}>
                                    ...
                                    <span className="text-sm transition-colors duration-200 font-medium">Assessment Panel</span>
                                </Link>
                                <Link href='/subscription' onClick={toggleNav} className={`flex items-center gap-2 px-3 py-3 mb-2 rounded-md ${currentPath === '/subscription' ? 'bg-white text-[#2D68A2] active-link' : 'text-[#181A1B]'} text-[#181A1B] hover:bg-white hover:text-[#2D68A2]`}>
                                ...
                                <Link href='/courses' onClick={toggleNav} className={`flex items-center gap-2 px-3 py-3 mb-2 rounded-md ${currentPath === '/courses' ? 'bg-white text-[#2D68A2] active-link' : 'text-[#181A1B]'} text-[#181A1B] hover:bg-white hover:text-[#2D68A2]`}>
                                    ...
                                    <span className="text-sm transition-colors duration-200 font-medium">Courses</span>
                                </Link>
                                <Link href='/users' onClick={toggleNav} className={`flex items-center gap-2 px-3 py-3 mb-2 rounded-md ${currentPath === '/users' ? 'bg-white text-[#2D68A2] active-link' : 'text-[#181A1B]'} text-[#181A1B] hover:bg-white hover:text-[#2D68A2]`}>
