        ...
        <div className="py-3 px-1 rounded-lg border-2 border-[#EAECF0] fixed w-[22%] h-[88vh]">
            ...
            <div className="mt-8">
                <ul className="side-links">
                    <li className={`flex items-center gap-2 px-3 py-3 mb-2 rounded-md ${currentPath === '/assessment' ? 'bg-white text-[#2D68A2] active-link' : 'text-[#181A1B]'} hover:bg-white hover:text-[#2D68A2]`}>
                    ...
                    <li className={`flex items-center gap-2 px-3 py-3 mb-2 rounded-md ${currentPath === '/my-account' ? 'bg-white text-[#2D68A2] active-link' : 'text-[#181A1B]'} text-[#181A1B] hover:bg-white hover:text-[#2D68A2]`}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
