        ...
        <div className="py-3 px-1 rounded-lg border-2 border-[#EAECF0] fixed w-[22%] h-[88vh]">
            ...
            <div className="mt-8">
                <ul className="side-links">
                    <li className={`flex items-center gap-2 px-3 py-3 rounded-md ${currentPath === '/assessment' ? 'bg-white text-[#2D68A2] active-link' : 'text-[#181A1B]'} hover:bg-white hover:text-[#2D68A2]`}>
                    ...
                    <li className={`flex items-center gap-2 px-3 py-3 rounded-md ${currentPath === '/subscription' ? 'bg-white text-[#2D68A2] active-link' : 'text-[#181A1B]'} text-[#181A1B] hover:bg-white hover:text-[#2D68A2]`}>
                    ...
                    <li className={`flex items-center gap-2 px-3 py-3 rounded-md ${currentPath === '/support' ? 'bg-white text-[#2D68A2] active-link' : 'text-[#181A1B]'} text-[#181A1B] hover:bg-white hover:text-[#2D68A2]`}>
                        ...
                        <Link className="text-sm transition-colors duration-200 font-medium" href='/assessment'>Support</Link>
                    </li>
                    <li className={`flex items-center gap-2 px-3 py-3 rounded-md ${currentPath === '/courses' ? 'bg-white text-[#2D68A2] active-link' : 'text-[#181A1B]'} text-[#181A1B] hover:bg-white hover:text-[#2D68A2]`}>
                    ...
                    <li className={`flex items-center gap-2 px-3 py-3 rounded-md ${currentPath === '/users' ? 'bg-white text-[#2D68A2] active-link' : 'text-[#181A1B]'} text-[#181A1B] hover:bg-white hover:text-[#2D68A2]`}>
                    ...
                    <li className={`flex items-center gap-2 px-3 py-3 rounded-md ${currentPath === '/my-account' ? 'bg-white text-[#2D68A2] active-link' : 'text-[#181A1B]'} text-[#181A1B] hover:bg-white hover:text-[#2D68A2]`}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                        ...
                        <Link className="text-sm transition-colors duration-200 font-medium" href='/assessment'>My Account</Link>
                    </li>
                    <li className={`flex items-center gap-2 px-3 py-3 rounded-md ${currentPath === '/' ? 'bg-white text-[#2D68A2] active-link' : 'text-[#181A1B]'} text-[#181A1B] hover:bg-white hover:text-[#2D68A2]`}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
