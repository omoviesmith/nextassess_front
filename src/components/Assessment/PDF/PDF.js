...
// const PDF = forwardRef((props, ref) => {
//     return (
//         <div id="container" ref={ref} className="w-full edit-container bg-white container-pdf rounded-[30px] border border-[#A9A9A9] mt-15 hidden">
//             <div className="p-24">
//                 <h1 className="text-black text-9xl font-bold mb-9">
//                     {props?.data?.title_assessment}
//                 </h1>
//             </div>
//             <div className="m-0 h-[3px] bg-[#A9A9A9]"></div>
//             <div className="px-24 py-18">
//                 <h6 className="text-black font-bold text-[45px] leading-[78px] mb-6">
//                     Overview And Rationale:{" "}
//                 </h6>
//                 <p className="text-[#666666] font-normal text-[45px] leading-[78px]">
//                     {props?.data?.overview_and_rationale}
//                 </p>
//             </div>
//             <div className="m-0 h-[3px] bg-[#A9A9A9]"></div>
//             <div className="px-24 py-18">
//                 <h6 className="text-black font-bold text-[45px] leading-[78px]">
//                     Assessment Unit:{" "}
//                 </h6>
//                 <p className="text-[#666666] font-normal text-[45px] leading-[78px] mb-9">
//                     {props?.data?.assessment_unit}
//                 </p>
//             </div>
//             <div className="m-0 h-[3px] bg-[#A9A9A9]"></div>
...
//                     Assessment Description:{" "}
//                 </h6>
//                 <div className="assessment-description pl-12" dangerouslySetInnerHTML={{ __html: props?.data?.assessment_description }}></div>
//             </div>
//             <div className="m-0 h-[3px] bg-[#A9A9A9]"></div>
//             <div className="px-24 py-18">
//                 <h6 className="text-black font-bold text-[45px] leading-[78px]">
//                     Submission Requirements
//                 </h6>
//                 <div className="pl-12" dangerouslySetInnerHTML={{ __html: props?.data?.submission_requirements }}></div>
//             </div>
//             <div className="m-0 h-[3px] bg-[#A9A9A9]"></div>
//             {/* Marking Rubric Section */}
//             <div className="w-full py-24 px-12 marking-rubric">
//                 <h6 className="text-black font-bold text-[45px] leading-[78px] mb-6">
//                     Marking Rubric:{" "}
//                 </h6>
//                 <div className="overflow-x-auto">
//                     <div className="min-w-full">
//                         <table className="w-full min-w-max table-fixed text-3xl">
//                             <thead>
//                                 <tr>
//                                     <th scope="col" className="py-9 px-3 md:px-3 w-96 font-normal md:font-semibold text-3xl uppercase border border-[#A9A9A9]">
//                                         Criteria
//                                     </th>
//                                     <th scope="col" className="py-9 px-3 md:px-3 w-72 font-normal md:font-semibold text-3xl uppercase border border-[#A9A9A9]">
//                                         Weighting
//                                     </th>
//                                     <th scope="col" className="py-9 px-3 md:px-3 w-60 font-normal md:font-semibold text-3xl uppercase border border-[#A9A9A9]">
//                                         Fail
//                                     </th>
//                                     <th scope="col" className="py-9 px-3 md:px-3 w-72 font-normal md:font-semibold text-3xl uppercase border border-[#A9A9A9]">
//                                         Pass Grade
...
//                                 {props?.data?.marking_rubric.map((item, index) => (
//                                     <tr key={index} className='bg-white'>
//                                         <td className="py-9 px-3 md:px-3 font-normal md:font-semibold text-3xl border border-[#A9A9A9]">
//                                             {item.criteria}
//                                         </td>
//                                         <td className="py-9 px-3 md:px-3 font-normal text-[36px] text-[#666666] border border-[#A9A9A9]">
//                                             {item.weighting}
//                                         </td>
//                                         <td className="py-9 px-3 md:px-3 font-normal text-[36px] text-[#666666] border border-[#A9A9A9]">
//                                             {item.fail}
