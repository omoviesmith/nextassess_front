    ...
    return (
        <div>
            ...
            <form onSubmit={handleSubmit} className=" md:w-1/2 mx-auto">
                ...
                <div className="mt-8">
                    <button type="submit" disabled={selectedFile ? false : true} className={`w-full text-center rounded-lg py-3 px-6 font-bold text-base ${selectedFile ? 'bg-[#CBFFFE]' : 'bg-[#CCCCCC]'}`}>Submit</button>
                </div>
            </form>
        </div>
    )
