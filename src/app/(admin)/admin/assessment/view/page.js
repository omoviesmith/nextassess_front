            ...
            <div className="md:w-1/2 mx-auto bg-white rounded-[10px] border border-[#A9A9A9] mt-5">
                <div className="p-8">
                    <h1 className="text-black text-3xl font-bold leading-[50px] mb-3">
                        {responseData?.title_assessment}
                    </h1>
                    <p className="text-[#666666] font-normal text-[15px] leading-[26px]">
                        {responseData?.overview_and_rationale}
                    </p>
                </div>
                ...
                <div className="p-8">
                    ...
                    <p className="text-[#666666] font-normal text-[15px] leading-[26px] mb-3">
                        {responseData?.assessment_unit}
                    </p>
                    <h6 className="text-[#666666] font-bold text-[15px] leading-[26px]">
                        Weight:{" "}
                    </h6>
                    <p className="text-[#666666] font-normal text-[15px] leading-[26px] mb-3">
                        {responseData?.percentage_weighting}
                    </p>
                    <h6 className="text-[#666666] font-bold text-[15px] leading-[26px]">
                        Due Date:{" "}
                    </h6>
                    ...
                    <p className="text-[#666666] font-normal text-[15px] leading-[26px] mb-3">
                        {responseData?.assessment_description}
                    </p>
                    <h6 className="text-[#666666] font-bold text-[15px] leading-[26px]">
                        Learning Outcomes
                    </h6>
                    <ul className="m-0 list-disc">
                        {
                            responseData?.learning_outcome.map((outcome, index) => (
                    ...
                    <div className="overflow-x-auto">
                        <div className="min-w-full">
                            <table className="w-full min-w-max  table-fixed">
                                ...
                                <tbody className="">
                                    {responseData?.marking_rubric.map((item, index) => (
